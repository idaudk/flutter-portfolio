...
import 'package:portfolio_daudk/data/models/work_model.dart';
 ...
 abstract class Constants{
  ...
  static const areYouReady = 'Are you ready to take your brand to new heights? Let\'s have a quick chat to discuss your needs and how I can best help your brand reach its full potential.';
  static const areYouReady2 = 'Are you ready to take your brand to new heights? Let\'s have a quick chat to\ndiscuss your needs and how I can best help your brand reach its full potential.';
  ...
  Experience(
      ...
      linkName: 'techkor.co',
      tags: ['wordpress', 'software engineering', 'requirements engineering'],
      description:
